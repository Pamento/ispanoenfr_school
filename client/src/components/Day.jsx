    ...
    >
      {isHovered ? (
        <div className="box-day box-coral">
          <p className="dialog-message p-size-medium">{props.message1}</p>
          <p className="dialog-message p-size-medium"><span className="text-bold">{props.spanBold}</span>{props.message2}</p>
        </div>
      ) : (
